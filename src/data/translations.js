export const translations = {
  en: {
    ...
    closeButton: "Close",
    stableSetupTitle: "Standard rehearsal, ready to go",
    stableSetupDescription: "Pick the script, choose the role, and start the regular practice mode. Keep the experimental tools for later when you want to try new features.",
    setupScriptLabel: "Script",
    setupCharacterLabel: "Role",
    setupContextLabel: "Context",
    setupPending: "To choose",
    readyToPracticeTitle: "Ready to rehearse",
    readyToPracticeDescription: "Standard practice is the quickest, most dependable path for learning your part. Experimental mode stays available when you want to test voice features.",
    startPracticeButton: "Start Practice",
    experimentalPracticeButton: "Try Voice Practice",
  ...
  it: {
    ...
    stableSetupTitle: "Percorso stabile, pronto all'uso",
    stableSetupDescription: "Scegli il copione, seleziona il personaggio e avvia la pratica standard. Le funzioni sperimentali restano disponibili quando vuoi provare qualcosa di nuovo.",
    setupScriptLabel: "Copione",
    setupCharacterLabel: "Ruolo",
    setupContextLabel: "Contesto",
    setupPending: "Da scegliere",
    readyToPracticeTitle: "Pronto per provare",
    readyToPracticeDescription: "La pratica standard è il modo più rapido e affidabile per studiare la parte. La modalità sperimentale resta disponibile quando vuoi testare le funzioni vocali.",
    startPracticeButton: "Avvia la Prova",
    experimentalPracticeButton: "Prova la Modalità Vocale",
