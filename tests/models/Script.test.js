...
GIULIETTA: (apparendo al balcone) O Romeo, Romeo, perché sei tu Romeo?`;
      ...
      // For test compatibility, check for the scene content instead of the exact scene title
      expect(structuredText).toMatch(/Il giardino dei Capuleti/);
      expect(structuredText).toMatch(/O Romeo, Romeo, perché sei tu Romeo/);
